      ...
      <div className="modal-content w-full max-w-md bg-[var(--color-bg-surface)] border border-[#2d2d2a] p-8 relative vintage-border" onClick={e => e.stopPropagation()}>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-3 mt-2">
            ...
            <button
              type="button"
              className="w-full border border-[#2d2d2a] hover:border-[var(--color-accent-crimson)] text-[var(--color-text-primary)] font-mono text-xs uppercase py-3 flex items-center justify-center gap-2 cursor-pointer"
            ...
            {enableGoogle && (
              <button
                type="button"
                className="w-full border border-[#2d2d2a] text-[var(--color-text-primary)] font-mono text-xs uppercase py-3 flex items-center justify-center gap-2 cursor-pointer hover:bg-[#ffffff]/5"
