    ...
    <div className="flex items-center gap-4">
      {session ? (
        <div className="flex items-center gap-4">
          <a href="/profile" className="flex items-center gap-2 hover:text-[var(--color-accent-crimson)]">
            {profile?.avatar_url ? (
              <img 
                ...
                className="w-7 h-7 rounded-full object-cover border border-[#2d2d2a]" 
                width="28" 
                height="28" 
              />
            ) : (
              <div className="w-7 h-7 rounded-full bg-[var(--color-bg-surface)] border border-[#2d2d2a] flex items-center justify-center text-xs font-mono text-[var(--color-text-secondary)]">
          ...
          <button 
            className="text-xs font-mono border border-[#2d2d2a] px-3 py-1.5 hover:border-[var(--color-accent-crimson)] hover:text-[var(--color-accent-crimson)] cursor-pointer"
